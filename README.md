...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fn5cwrm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fn5cwrm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Axolotlstk1/container-fn5cwrm.git
cd container-fn5cwrm
```
...
```
docker attach container-fn5cwrm
```
